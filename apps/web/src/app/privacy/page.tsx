...
const PDF_PATH = '/privacy-policy.pdf';
const PDF_DOWNLOAD_NAME = '개인정보처리방침.pdf';
      ...
      <main className="flex-1 bg-page-bg">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-10 sm:py-14">
          <div className="flex items-center justify-between mb-6 gap-3 flex-wrap">
            <h1 className="text-2xl sm:text-3xl font-bold text-text-primary">개인정보처리방침</h1>
            <a
              href={PDF_PATH}
          ...
          <div className="bg-white rounded-xl border border-border shadow-sm overflow-hidden">
            {/* iframe 이 <object> 보다 Windows/Chrome·Edge 호환성 좋음.
                PDF 자체가 로드 안 되는 환경(IE 등 미지원)은 아래 fallback 링크 노출. */}
            <iframe
              src={PDF_PATH}
